...
//        String lettersOnBoard = ""
    ...
    private static ArrayList<String> evaluateRegex(String regex) {
...
//
        System.out.printf("There are %s matches from the regex.\n", list.size());
        return list;
    }

    private static void importWholeDictionary(List<String> listPassedIn) throws IOException {
